...
def downsize_images(images, target_size=256):
...
def main():
    ...
    for idx in tqdm(range(num_steps)):
        ...
        gen_imgs_latent = downsize_images(gen_imgs_latent)
        gen_imgs_latent_orig = downsize_images(gen_imgs_latent_orig)
        ...
        if args.optint:
            ...
            gen_imgs_dec_latent = downsize_images(gen_imgs_dec_latent)
